<template>
  <div class="hero">
    <div class="top">
      <div class="details">
        <h2>Oi, I'm</h2>
        <h1 class="name">Yaasir Falana</h1>
        <h2 class="profession">Frontend Web Developer</h2>
        <p class="about">
          Goal-oriented Frontend Developer with experience in web design and
          development.
        </p>
        <p class="about">
          Proficient in HTML, CSS, JavaScript with modern frameworks and
    ...
    <div class="bottom">
      <div class="social-links">
        ...
        <a
          href="https://www.linkedin.com/in/yaasir-falana-a29962233/"
          target="_blank"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://twitter.com/YaasirFalana" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            fill="currentColor"
